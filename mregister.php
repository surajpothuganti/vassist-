			...
			<main class="main-content">
				...
				<div class="fullwidth-block content">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-5">
							<form action="mlogin.php" class="contact-form">
							...
							<div class="col-md-6 col-md-offset-1">
								<div class="map-container">
									<form action="mregister1.php" method="post" class="contact-form">
                                        <input type="text" id="name" name="name" placeholder="Name" required="required">
                                        <input type="text" id="email" name="mail"placeholder="Email"required="required">
										...
										<input type="text" id="phonenumber" name="phno" placeholder="Phone number" required="required">
										<!--input type="text" id="repairs" name="repairs" placeholder="No of repairs" required="required"-->
										<input type="text" id="pincode" name="pin" placeholder="Pincode" required="required">
                                        <textarea name="address" id="address" placeholder="Address"></textarea>
										<!--input type="text" id="nms" name="nms" placeholder="No of Mechanics Working " required="required"-->
